 ...
 * Сериализует стандартные типы (примитивы, оболочки, строки), пользовательские объекты(не дженерики), массивы
 * (в том числе многомерные)
 * Много быдлокода, сделано в лоб, примерная идея (десереализации) такова:
 *
 * Считываем файл в строку.
 * Через рефлексию получаем нужные поля, помеченные аннотацией, включая родительские, вплоть до Object'а.
